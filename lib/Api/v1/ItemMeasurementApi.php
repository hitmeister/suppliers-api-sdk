...
class ItemMeasurementApi
{
     ...
     *
     * @param  \SMS\Suppliers\Model\v1\CreateItemMeasurementRequest $body body (required)
     *
     ...
     * Create item-measurement by gtin (for crossdock & wholesaler)
     *
     * @param  \SMS\Suppliers\Model\v1\CreateItemMeasurementRequest $body (required)
     *
     * @throws \SMS\Suppliers\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \SMS\Suppliers\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SMS\Suppliers\Model\v1\ItemMeasurementResponse
     */
     ...
     * @throws \SMS\Suppliers\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SMS\Suppliers\Model\v1\ItemMeasurementResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getItemMeasurementWithHttpInfo($gtin)
    {
        $returnType = '\SMS\Suppliers\Model\v1\ItemMeasurementResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SMS\Suppliers\Model\v1\ItemMeasurementResponse',
