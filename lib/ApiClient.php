...
class ApiClient
{
     ...
     */
    public function __construct(\Suppliers\Api\Configuration $config = null)
    {
        if ($config === null) {
     ...
     *
     * @throws \Suppliers\Api\ApiException on a non 2xx response
     * @return mixed
     */
    public function callApi($resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null)
    {
        ...
        if ($postData and in_array('Content-Type: application/x-www-form-urlencoded', $headers, true)) {
            ...
            $postData = json_encode(\Suppliers\Api\ObjectSerializer::sanitizeForSerialization($postData));
        }
