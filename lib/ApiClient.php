...
class ApiClient
{
     ...
     */
    public function __construct(\SMS\Suppliers\Configuration $config = null)
    {
        if ($config === null) {
     ...
     *
     * @throws \SMS\Suppliers\ApiException on a non 2xx response
     * @return mixed
     */
    public function callApi($resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null)
    {
        ...
        if ($postData and in_array('Content-Type: application/x-www-form-urlencoded', $headers, true)) {
            ...
            $postData = json_encode(\SMS\Suppliers\ObjectSerializer::sanitizeForSerialization($postData));
        }
