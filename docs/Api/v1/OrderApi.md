...
$apiInstance = new SMS\Suppliers\Api\v1\OrderApi(
...
# **getOrder**
> \SMS\Suppliers\Model\v1\GetFulfilmentOrderResponse getOrder($id)
...
[**\SMS\Suppliers\Model\v1\GetFulfilmentOrderResponse**](../Model/GetFulfilmentOrderResponse.md)
...
# **getOrders**
> \SMS\Suppliers\Model\v1\GetFulfilmentOrdersResponse getOrders($created_at, $open, $limit, $page)
...
[**\SMS\Suppliers\Model\v1\GetFulfilmentOrdersResponse**](../Model/GetFulfilmentOrdersResponse.md)
