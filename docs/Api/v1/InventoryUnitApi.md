...
# **createInventoryUnit**
> \SMS\Suppliers\Model\v1\CreateInventoryUnitResponse createInventoryUnit($body)
...
$apiInstance = new SMS\Suppliers\Api\v1\InventoryUnitApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$body = new \SMS\Suppliers\Model\v1\CreateInventoryUnitRequest(); // \SMS\Suppliers\Model\v1\CreateInventoryUnitRequest | Inventory unit object that needs to be added to the inventory
...
------------- | ------------- | ------------- | -------------
 **body** | [**\SMS\Suppliers\Model\v1\CreateInventoryUnitRequest**](../Model/CreateInventoryUnitRequest.md)| Inventory unit object that needs to be added to the inventory |

### Return type

[**\SMS\Suppliers\Model\v1\CreateInventoryUnitResponse**](../Model/CreateInventoryUnitResponse.md)
...
# **getInventoryUnit**
> \SMS\Suppliers\Model\v1\GetInventoryUnitResponse getInventoryUnit($id)
...
[**\SMS\Suppliers\Model\v1\GetInventoryUnitResponse**](../Model/GetInventoryUnitResponse.md)
...
# **getInventoryUnits**
> \SMS\Suppliers\Model\v1\GetInventoryUnitResponse[] getInventoryUnits($limit, $page)
...
$body = new \SMS\Suppliers\Model\v1\UpdateInventoryUnitRequest(); // \SMS\Suppliers\Model\v1\UpdateInventoryUnitRequest | Inventory unit object that needs to be updated
 ...
 **body** | [**\SMS\Suppliers\Model\v1\UpdateInventoryUnitRequest**](../Model/UpdateInventoryUnitRequest.md)| Inventory unit object that needs to be updated | [optional]
