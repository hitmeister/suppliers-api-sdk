...
$apiInstance = new SMS\Suppliers\Api\v2\InventoryApi(
...
$body = new \SMS\Suppliers\Model\v2\CreateImportRequest(); // \SMS\Suppliers\Model\v2\CreateImportRequest | Inventory import request which stores all the necessary info
 ...
 **body** | [**\SMS\Suppliers\Model\v2\CreateImportRequest**](../Model/CreateImportRequest.md)| Inventory import request which stores all the necessary info |
...
# **getInventory**
> \SMS\Suppliers\Model\v2\GetInventoryResponse getInventory($id)
...
[**\SMS\Suppliers\Model\v2\GetInventoryResponse**](../Model/GetInventoryResponse.md)
