...
Please use `SMS\Suppliers\Configuration::getDefaultConfiguration()->setApiVersion($apiVersion)` to set the API version (1 or 2)
and make sure you then use the classes with the correct namespace to create your requests. Using a class of the wrong version
...
------------ | ------------- | ------------- | -------------
*InventoryApi* | [**createImportRequest**](docs/Api/v1/InventoryApi.md#createimportrequest) | **POST** /inventories/{id}/import-requests | Create new inventory import
*InventoryApi* | [**getInventory**](docs/Api/v1/InventoryApi.md#getinventory) | **GET** /inventories/{id} | Find inventory by ID
*InventoryUnitApi* | [**createInventoryUnit**](docs/Api/v1/InventoryUnitApi.md#createinventoryunit) | **POST** /inventory-units | Create new inventory unit
*InventoryUnitApi* | [**deleteInventoryUnit**](docs/Api/v1/InventoryUnitApi.md#deleteinventoryunit) | **DELETE** /inventory-units/{id} | Delete inventory unit by supplier_item_id
*InventoryUnitApi* | [**getInventoryUnit**](docs/Api/v1/InventoryUnitApi.md#getinventoryunit) | **GET** /inventory-units/{id} | Find inventory unit by supplier_item_id
*InventoryUnitApi* | [**getInventoryUnits**](docs/Api/v1/InventoryUnitApi.md#getinventoryunits) | **GET** /inventory-units | Find all inventory units
*InventoryUnitApi* | [**updateInventoryUnit**](docs/Api/v1/InventoryUnitApi.md#updateinventoryunit) | **PATCH** /inventory-units/{id} | Update inventory unit
*ItemMeasurementApi* | [**createItemMeasurement**](docs/Api/v1/ItemMeasurementApi.md#createitemmeasurement) | **POST** /item-measurements | Create item-measurement by gtin (for crossdock &amp; wholesaler)
*ItemMeasurementApi* | [**getItemMeasurement**](docs/Api/v1/ItemMeasurementApi.md#getitemmeasurement) | **GET** /item-measurements/{gtin} | Find item-measurement by gtin
*OrderApi* | [**confirmOrder**](docs/Api/v1/OrderApi.md#confirmorder) | **POST** /orders/{id}/confirm | Confirm order
*OrderApi* | [**getOrder**](docs/Api/v1/OrderApi.md#getorder) | **GET** /orders/{id} | Find order by ID
*OrderApi* | [**getOrders**](docs/Api/v1/OrderApi.md#getorders) | **GET** /orders | Find all orders by given parameters
*OrderUnitApi* | [**cancelOrderUnit**](docs/Api/v1/OrderUnitApi.md#cancelorderunit) | **POST** /order-units/{id}/cancel | Cancel an order unit
*OrderUnitApi* | [**getOrderUnit**](docs/Api/v1/OrderUnitApi.md#getorderunit) | **GET** /order-units/{id} | Find order unit by ID
*OrderUnitApi* | [**pickOrderUnit**](docs/Api/v1/OrderUnitApi.md#pickorderunit) | **POST** /order-units/{id}/pick | Change order unit status to &#39;picking&#39;
*OrderUnitApi* | [**sendOrderUnit**](docs/Api/v1/OrderUnitApi.md#sendorderunit) | **POST** /order-units/{id}/send | Send an order unit
*OrderUnitApi* | [**updateOrderUnitShipment**](docs/Api/v1/OrderUnitApi.md#updateorderunitshipment) | **POST** /order-units/{id}/shipment | Update shipment data of the order unit
*SubscriptionApi* | [**createSubscription**](docs/Api/v1/SubscriptionApi.md#createsubscription) | **POST** /subscriptions | Create new subscription
*SubscriptionApi* | [**deleteSubscription**](docs/Api/v1/SubscriptionApi.md#deletesubscription) | **DELETE** /subscriptions/{id} | Delete existing subscription
*SubscriptionApi* | [**updateSubscription**](docs/Api/v1/SubscriptionApi.md#updatesubscription) | **PATCH** /subscriptions/{id} | Update existing subscription
*SubscriptionApi* | [**viewSubscription**](docs/Api/v1/SubscriptionApi.md#viewsubscription) | **GET** /subscriptions/{id} | View existing subscription
*SubscriptionApi* | [**viewSubscriptions**](docs/Api/v1/SubscriptionApi.md#viewsubscriptions) | **GET** /subscriptions | Get all existing subscriptions


### Models

 - [BadRequestResponse](docs/Model/v1/BadRequestResponse.md)
 - [CancelOrderUnitRequest](docs/Model/v1/CancelOrderUnitRequest.md)
 - [CreateImportRequest](docs/Model/v1/CreateImportRequest.md)
 - [CreateInventoryUnitRequest](docs/Model/v1/CreateInventoryUnitRequest.md)
 - [CreateInventoryUnitResponse](docs/Model/v1/CreateInventoryUnitResponse.md)
 - [CreateItemMeasurementRequest](docs/Model/v1/CreateItemMeasurementRequest.md)
 - [CreateSubscriptionRequest](docs/Model/v1/CreateSubscriptionRequest.md)
 - [CreateSubscriptionResponse](docs/Model/v1/CreateSubscriptionResponse.md)
 - [GetFulfilmentOrderResponse](docs/Model/v1/GetFulfilmentOrderResponse.md)
 - [GetFulfilmentOrderUnitResponse](docs/Model/v1/GetFulfilmentOrderUnitResponse.md)
 - [GetFulfilmentOrdersResponse](docs/Model/v1/GetFulfilmentOrdersResponse.md)
 - [GetInventoryResponse](docs/Model/v1/GetInventoryResponse.md)
 - [GetInventoryUnitResponse](docs/Model/v1/GetInventoryUnitResponse.md)
 - [Item](docs/Model/v1/Item.md)
 - [ItemMeasurementResponse](docs/Model/v1/ItemMeasurementResponse.md)
 - [SendOrderUnitRequest](docs/Model/v1/SendOrderUnitRequest.md)
 - [ShipmentAddress](docs/Model/v1/ShipmentAddress.md)
 - [ShipmentData](docs/Model/v1/ShipmentData.md)
 - [UpdateInventoryUnitRequest](docs/Model/v1/UpdateInventoryUnitRequest.md)
 - [UpdateOrderUnitShipmentDataRequest](docs/Model/v1/UpdateOrderUnitShipmentDataRequest.md)
 - [UpdateSubscriptionRequest](docs/Model/v1/UpdateSubscriptionRequest.md)
 - [UpdateSubscriptionResponse](docs/Model/v1/UpdateSubscriptionResponse.md)
 - [User](docs/Model/v1/User.md)
 - [ViewSubscriptionResponse](docs/Model/v1/ViewSubscriptionResponse.md)
